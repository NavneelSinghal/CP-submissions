...
void solve() {
    //first check if all components of the graph are bipartite
    //if it is not bipartite, then answer = 1
    //else for every component, if the sizes of the two bipartitions are n, m, then the contribution of this to the answer is nC2 + mC2
    int n, m;
    cin >> n >> m;
    g.resize(n);
    col.resize(n);
