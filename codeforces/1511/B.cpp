...
vector<ll> primes1 = {1, 11, 101, 1013, 17389, 104729, 2750159, 32452843, 373587883};
vector<ll> primes2 = {3, 13, 103, 1223, 17393, 224743, 2750161, 32452841, 373587881};
...
void solve(int) {
    ...
    b -= c - 1;
    ll p = pwr(ll(10), c - 1);
    cout << primes1[a - 1] * p << ' ' << primes2[b - 1] * p << '\n';
}
