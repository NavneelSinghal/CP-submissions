...
void solve(int case_no) {
    ...
    vector<int> num(n); // number of vertices in a component
    ...
    for (int i = 0; i < n; ++i) {
        num[i] = (num[i] > 1); // log_2(number of paths through a given vertex)
    }
